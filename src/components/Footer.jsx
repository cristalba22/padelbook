...
export default function Footer() {
  ...
  const mapsQuery = settings.mapsQuery || settings.address;
  ...
  return <footer className="site-footer">
    <div className="site-footer__inner">
      <div className="site-footer__intro"><span className="site-footer__eyebrow">PADELBOOK</span><Link to={ROUTES.HOME} className="site-footer__brand"><span aria-hidden="true">p.</span>padelbook</Link><p>Reservas y gestión de clubes de pádel.</p></div>
