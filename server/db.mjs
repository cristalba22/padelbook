...
const settingsSchema = new mongoose.Schema({
  ...
  clubStatus: { type: String, default: "Reservas online" },
  homeHeadline: { type: String, default: "Nos vemos en la cancha." },
  homeSubtitle: { type: String, default: "Elegí cancha y horario. El club recibe la reserva y podés seguir su estado desde tu cuenta." },
